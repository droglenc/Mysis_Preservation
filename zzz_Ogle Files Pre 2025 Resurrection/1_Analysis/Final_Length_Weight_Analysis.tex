...
$`Juv:8BF`
     Min.   1st Qu.    Median      Mean   3rd Qu.      Max.     StDev 
6.8000000 7.2250000 7.6000000 7.7080000 8.1750000 9.0000000 0.7292067 

$`Juv:8SBF`
    Min.  1st Qu.   Median     Mean  3rd Qu.     Max.    StDev 
4.000000 6.100000 7.200000 7.127000 8.200000 9.900000 1.327730 

$`Juv:Fresh`
    Min.  1st Qu.   Median     Mean  3rd Qu.     Max.     NA's    StDev 
4.800000 6.075000 6.800000 6.850000 7.625000 8.800000 1.000000 1.079021 
...
The mean log(weight) adjusted for log(length) did not differ among male and females (p=0.4038).
...
> lines(c(8.9, 19.5), 10^c(3.0658 * log10(8.9) - 2.7185, 3.0665 * log10(19.5) - 
+     2.7185), lwd = 3, col = "gray", lty = 2)
> lines(c(8.2, 19.5), 10^c(3.0658 * log10(8.2) - 2.5823, 3.0665 * log10(19.5) - 
+     2.5823), lwd = 3, col = "gray", lty = 1)
> lines(c(13.7, 19.5), 10^c(3.0658 * log10(13.7) - 2.5587, 3.0665 * log10(19.5) - 
